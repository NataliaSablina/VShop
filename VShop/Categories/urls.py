...
from .views import ProductView, SearchResultsView, CategoriesProductsView, CategoryProductsView, like_product, \
    ...
    SortFilterPageView, SortProducts, MostPopularProductsView
...
urlpatterns = [
    ...
    path('recommended', RecommendedProductsView.as_view(), name='recommended'),
    ...
    path('most_popular', MostPopularProductsView.as_view(), name='most_popular'),

...
from .views import UserPageView, logout_view, DeactivateAccountView, DeleteAccountView, \
    ForgotPasswordView, contact_view, ChangePasswordView, TermsConditionsView, AddressView, \
    ActivateAccountView, \
...
urlpatterns = [
    ...
    path('check_status_of_my_order_not_log_in', HelpCheckStatusOfMYOrderNotLogInView.as_view(),
         name='check_status_of_my_order_not_log_in'),
    path('change_items_of_my_order', HelpChangeItemsOfMyOrderView.as_view(), name='change_items_of_my_order'),
    path('change_items_of_my_order_not_log_in', HelpChangeItemsOfMyOrderNotLogInView.as_view(),
         name='change_items_of_my_order_not_log_in'),
    ...
    path('change_my_delivery_address_not_log_in', HelpChangeMyDeliveryAddressNotLogInView.as_view(),
         name='change_my_delivery_address_not_log_in'),
    path('help_with_a_pick-up_order', HelpPickUpOrderView.as_view(), name='help_with_a_pick-up_order'),
    path('help_with_a_pick-up_order_not_log_in', HelpPickUpOrderNotLogInView.as_view(),
         name='help_with_a_pick-up_order_not_log_in'),
    path('my_delivery_person_made_me_unsafe', HelpDeliveryPersonMadeUnsafeView.as_view(),
         name='my_delivery_person_made_me_unsafe'),
    path('my_delivery_person_made_me_unsafe_not_log_in', HelpDeliveryPersonMadeUnsafeNotLogInView.as_view(),
         name='my_delivery_person_made_me_unsafe_not_log_in'),
    path('refunding_payment', HelpRefundingPaymentView.as_view(), name='refunding_payment'),
    path('refunding_payment_not_log_in', HelpRefundingPaymentNotLogInView.as_view(),
         name='refunding_payment_not_log_in'),
